...
const LAST_UPDATED = '23 de março de 2025'
...
const SECTIONS: Section[] = [
    ...
    content: (
      <>
        ...
        <ul className={styles.list}>
          ...
          <li><strong>Cadastro via Google:</strong> nome, sobrenome, endereço de e-mail e foto de perfil fornecidos pela conta Google, mediante seu consentimento expresso ao autorizar o acesso OAuth.</li>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Todo tratamento de dados pessoais realizado pela Plataforma possui finalidade determinada e
