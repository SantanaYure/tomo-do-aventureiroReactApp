...
Ler e seguir a skill canônica em:

```text
.agents/skills/project-loops/SKILL.md
```

Usar `.ai/loops/` como fonte dos workflows, verificadores, contrato e registro. Não duplicar nem substituir essas fontes neste adaptador.
